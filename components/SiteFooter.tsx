...
export default function SiteFooter({ hideContactInfo = false }: Props) {
  return (
    <footer style={{ backgroundColor: brandBlue }} className="py-10 mt-16 text-sm">
      <div className="mx-auto max-w-6xl px-6 grid md:grid-cols-3 gap-8 items-center text-center md:text-left">
        {/* Logo and tagline */}
        <div className="flex flex-col items-center md:items-start gap-2">
          <Image
            src="/NovaCare_Logo_Dark.svg"  // gold wordmark for dark footer
        ...
        {!hideContactInfo && (
          <div style={{ color: brandGold }}>
            ...
            <p>
              📞 <a href="tel:+61488086271" className="hover:underline" style={{ color: brandGold }}>0488 086 271</a>
            </p>
            <p>
              ✉ <a href="mailto:info@novacarenursing.com.au" className="hover:underline" style={{ color: brandGold }}>info@novacarenursing.com.au</a>
            </p>
          </div>
        )}
