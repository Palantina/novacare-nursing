  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Profile of Palantina Hughes — Clinical Nursing Home Care Consultant and Registered Nurse in Hobart."
        />
      </Head>

      {/* Uses your existing header/footer; no global changes */}
      <SiteHeader />
